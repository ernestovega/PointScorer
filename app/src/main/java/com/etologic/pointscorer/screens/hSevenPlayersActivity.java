...
public class hSevenPlayersActivity extends AppCompatActivity {
    ...
    @BindView(R.id.tvNameP7) AppCompatEditText tvNameP7;
    ...
    @OnClick(R.id.btUpP1) void onP1UpButtonClick() { if(pointsP1 < 9999) pointsP1++; sharedPrefsHelper.saveSevenPlayerPointsP1(pointsP1); updatePointsP1(); }
    @OnClick(R.id.btUpP2) void onP2UpButtonClick() { if(pointsP2 < 9999) pointsP2++; sharedPrefsHelper.saveSevenPlayerPointsP2(pointsP2); updatePointsP2(); }
    @OnClick(R.id.btUpP3) void onP3UpButtonClick() { if(pointsP3 < 9999) pointsP3++; sharedPrefsHelper.saveSevenPlayerPointsP3(pointsP3); updatePointsP3(); }
    @OnClick(R.id.btUpP4) void onP4UpButtonClick() { if(pointsP4 < 9999) pointsP4++; sharedPrefsHelper.saveSevenPlayerPointsP4(pointsP4); updatePointsP4(); }
    @OnClick(R.id.btUpP5) void onP5UpButtonClick() { if(pointsP5 < 9999) pointsP5++; sharedPrefsHelper.saveSevenPlayerPointsP5(pointsP5); updatePointsP5(); }
    @OnClick(R.id.btUpP6) void onP6UpButtonClick() { if(pointsP6 < 9999) pointsP6++; sharedPrefsHelper.saveSevenPlayerPointsP6(pointsP6); updatePointsP6(); }
    @OnClick(R.id.btUpP7) void onP7UpButtonClick() { if(pointsP7 < 9999) pointsP7++; sharedPrefsHelper.saveSevenPlayerPointsP7(pointsP7); updatePointsP7(); }
    @OnClick(R.id.btDownP1) void onP1DownButtonClick() { if(pointsP1 > -999) pointsP1--; sharedPrefsHelper.saveSevenPlayerPointsP1(pointsP1); updatePointsP1(); }
    @OnClick(R.id.btDownP2) void onP2DownButtonClick() { if(pointsP2 > -999) pointsP2--; sharedPrefsHelper.saveSevenPlayerPointsP2(pointsP2); updatePointsP2(); }
    @OnClick(R.id.btDownP3) void onP3DownButtonClick() { if(pointsP3 > -999) pointsP3--; sharedPrefsHelper.saveSevenPlayerPointsP3(pointsP3); updatePointsP3(); }
    @OnClick(R.id.btDownP4) void onP4DownButtonClick() { if(pointsP4 > -999) pointsP4--; sharedPrefsHelper.saveSevenPlayerPointsP4(pointsP4); updatePointsP4(); }
    @OnClick(R.id.btDownP5) void onP5DownButtonClick() { if(pointsP5 > -999) pointsP5--; sharedPrefsHelper.saveSevenPlayerPointsP5(pointsP5); updatePointsP5(); }
    @OnClick(R.id.btDownP6) void onP6DownButtonClick() { if(pointsP6 > -999) pointsP6--; sharedPrefsHelper.saveSevenPlayerPointsP6(pointsP6); updatePointsP6(); }
    @OnClick(R.id.btDownP7) void onP7DownButtonClick() { if(pointsP7 > -999) pointsP7--; sharedPrefsHelper.saveSevenPlayerPointsP7(pointsP7); updatePointsP7(); }
            ...
            switch (item.getItemId()) {
                case R.id.menu_edit_name:
                    DialogUtils.showNameDialog(this, name -> {
                        sharedPrefsHelper.saveSevenPlayerNameP1(name);
    ...
    @OnClick(R.id.ibMenuP2) void onP2MenuButtonClick(View view) {
        ...
        popup.setOnMenuItemClickListener(item -> {
            switch (item.getItemId()) {
                case R.id.menu_edit_name:
                    DialogUtils.showNameDialog(this, name -> {
                        sharedPrefsHelper.saveSevenPlayerNameP2(name);
    ...
    @OnClick(R.id.ibMenuP3) void onP3MenuButtonClick(View view) {
        ...
        popup.setOnMenuItemClickListener(item -> {
            switch (item.getItemId()) {
                case R.id.menu_edit_name:
                    DialogUtils.showNameDialog(this, name -> {
                        sharedPrefsHelper.saveSevenPlayerNameP3(name);
    ...
    @OnClick(R.id.ibMenuP4) void onP4MenuButtonClick(View view) {
        ...
        popup.setOnMenuItemClickListener(item -> {
            switch (item.getItemId()) {
                case R.id.menu_edit_name:
                    DialogUtils.showNameDialog(this, name -> {
                        sharedPrefsHelper.saveSevenPlayerNameP4(name);
    ...
    @OnClick(R.id.ibMenuP5) void onP5MenuButtonClick(View view) {
        ...
        popup.setOnMenuItemClickListener(item -> {
            switch (item.getItemId()) {
                case R.id.menu_edit_name:
                    DialogUtils.showNameDialog(this, name -> {
                        sharedPrefsHelper.saveSevenPlayerNameP5(name);
    ...
    @OnClick(R.id.ibMenuP6) void onP6MenuButtonClick(View view) {
        ...
        popup.setOnMenuItemClickListener(item -> {
            switch (item.getItemId()) {
                case R.id.menu_edit_name:
                    DialogUtils.showNameDialog(this, name -> {
                        sharedPrefsHelper.saveSevenPlayerNameP6(name);
    ...
    @OnClick(R.id.ibMenuP7) void onP7MenuButtonClick(View view) {
        ...
        popup.setOnMenuItemClickListener(item -> {
            switch (item.getItemId()) {
                case R.id.menu_edit_name:
                    DialogUtils.showNameDialog(this, name -> {
                        sharedPrefsHelper.saveSevenPlayerNameP7(name);
    ...
    private void initNames() {
        ...
        tvNameP2.setText(sharedPrefsHelper.getSevenPlayerNameP2());
        tvNameP3.setText(sharedPrefsHelper.getSevenPlayerNameP3());
        tvNameP4.setText(sharedPrefsHelper.getSevenPlayerNameP4());
        tvNameP5.setText(sharedPrefsHelper.getSevenPlayerNameP5());
        tvNameP6.setText(sharedPrefsHelper.getSevenPlayerNameP6());
        tvNameP7.setText(sharedPrefsHelper.getSevenPlayerNameP7());
    }
