...
import com.etologic.pointscorer.databinding.GSixPlayersActivityBinding

class GSixPlayersFragment : BaseGameFragment() {
    
    private var fragmentBinding: GSixPlayersActivityBinding? = null
    private val binding: GSixPlayersActivityBinding get() = fragmentBinding!!
    
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        fragmentBinding = GSixPlayersActivityBinding.inflate(inflater, container, false)
        return binding.root
    }
