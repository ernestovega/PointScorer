...
public class gSixPlayersActivity extends AppCompatActivity {
    ...
    //CONSTANTS
    private static final String KEY_POINTS_P1 = "six_players_p1_points";
    private static final String KEY_POINTS_P2 = "six_players_p2_points";
    private static final String KEY_POINTS_P3 = "six_players_p3_points";
    private static final String KEY_POINTS_P4 = "six_players_p4_points";
    private static final String KEY_POINTS_P5 = "six_players_p5_points";
    private static final String KEY_POINTS_P6 = "six_players_p6_points";
    //VIEWS
